...
maintainer 'Tobby Kuyinu'
maintainer_email 'tobbykuyinu@yahoo.com'
license 'all_rights'
...
#
# issues_url 'https://github.com/<insert_org_here>/docker_services/issues' if respond_to?(:issues_url)
